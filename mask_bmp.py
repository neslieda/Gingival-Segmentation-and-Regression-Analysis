...
coco_json_path = r'C:\Users\edayu\PycharmProjects\Dental\DentalProject\dental\dental\gazi_gum_project\formatted_file.json'  # COCO JSON dosyanızın yolu

with open(coco_json_path, 'r') as json_file:
    coco_data = json.load(json_file)

# İlgili görsel için bilgileri seçin (örneğin, image_id'yi belirtin)
target_image_id =  17 # İlgili görselin image_id'si
