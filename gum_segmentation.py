import os, torch, cv2, numpy as np, albumentations as A
...
class CustomSegmentationDataset(Dataset):
    ...
    def __init__(self, root, data, transformations=None):
        ...
        self.gt_paths = sorted(glob(f"{root}/{data}/mask/*.jpg"))
...
root = r"C:\Users\edayu\PycharmProjects\Yapayzeka\dental\Diş eti akademik yapay zeka\gum2\gum\labels"
...
class Plot():
    ...
    def decorate(self, ylabel, title): plt.title(title); plt.xlabel("Epochs"); plt.ylabel(
        ylabel); plt.legend(); plt.show()
